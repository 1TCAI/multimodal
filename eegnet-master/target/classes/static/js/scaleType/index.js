...
$(document).ready(function () {
    ...
    $("#btn_new").click(function () {
        ...
        $('#myModal').modal('show');
        //window.location.href = "scaleType/update" ;
    });
...
function bindData() {
    var table = $('#table_list').dataTable({
        ...
        //     title: '题目数量'
        // }, {
        //     data: "separationCharacter",
        //     title: '分隔符'
        // }, {
        //     data: "formula",
        //     title: '公式'
        // }, {
        //     data: "judgementStandard",
        //     title: '评价标准'
        }, {
            data: "excelTitle",
            title: 'excel列标题'
            ...
            visible: false,
            "render" : function (data, type, full, meta) {
                var str = "<button style='display: none' class='btn btn-info btn-xs edit' type='button' onclick=\"editScaleType('"+ data + "')\"><i class='fa fa-edit'></i> 编辑</button>  ";
                str = str + "<button style='display: none' class='btn btn-danger btn-xs delete' type='button' onclick=\"deleteScaleType('"+ data +"')\"><i class='fa fa-trash'></i> 删除</button>";
                return str;
            }
        }],
        columnDefs: [{
...
function editScaleType(id) {
    ...
    initEditData(id);
    //window.location.href = "scaleType/update?id=" + id;
}

function deleteScaleType(id) {
    Confirm("确定要删除该数据?",
        function () {
            $.ajax({
                type: "POST",
